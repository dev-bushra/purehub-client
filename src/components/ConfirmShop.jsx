    ...
    <div className="w-full h-full">
      <div className="w-full h-full flex flex-col items-start justify-start gap-4">
        ...
        <p className="text-[#7C8DB0] text-sm sm:text-base font-medium">
          PureHub partners with thousands of hotels to get you the best deal.
        ...
        <div className="w-full h-[330px] flex flex-col items-start rounded-b-xl bg-white dealsShadow">
          ...
          <div className="w-full h-full flex flex-col justify-center items-start gap-1 px-4">
            <div className="flex flex-row items-center justify-between w-full">
              ...
              <p className="text-[#6E7491] text-base font-medium">SAR 439</p>
            </div>
        ...
        <div className="w-full h-[330px] flex flex-col items-start rounded-b-xl bg-white dealsShadow">
          ...
          <div className="w-full h-full flex flex-col justify-center items-start gap-1 px-4">
            <div className="flex flex-row items-center justify-between w-full">
              ...
              <p className="text-[#6E7491] text-base font-medium">SAR 139</p>
            </div>
            <p className="text-[#7C8DB0] text-sm font-normal">
        ...
        <div className="w-full h-[330px] flex flex-col items-start rounded-b-xl bg-white dealsShadow">
          ...
          <div className="w-full h-full flex flex-col justify-center items-start gap-1 px-4">
            <div className="flex flex-row items-center justify-between w-full">
              ...
              <p className="text-[#6E7491] text-base font-medium">SAR 529</p>
            </div>
            <p className="text-[#7C8DB0] text-sm font-normal">
        ...
        <div className="w-full h-[330px] flex flex-col items-start rounded-b-xl bg-white dealsShadow">
          ...
          <div className="w-full h-full flex flex-col justify-center items-start gap-1 px-4">
            <div className="flex flex-row items-center justify-between w-full">
              ...
              <p className="text-[#6E7491] text-base font-medium">SAR 59</p>
            </div>
            <p className="text-[#7C8DB0] text-sm font-normal">
      ...
      <div className="w-full h-full flex flex-col items-start justify-start gap-4">
        ...
        <p className="text-[#7C8DB0] text-sm sm:text-base font-medium">
        Find events and authentic cultrual experiences available exclusively to PureHub users.
        </p>
      </div>
      <div className="w-full h-full flex flex-col items-start gap-10 mt-14">
      <div className="w-full h-[330px] flex flex-col items-start rounded-b-xl bg-white dealsShadow">
          ...
          <div className="w-full h-full flex flex-col justify-center items-start gap-1 px-4">
            <div className="flex flex-row items-center justify-between w-full">
              ...
              <p className="text-[#6E7491] text-base font-medium">SAR 89</p>
            </div>
            <p className="text-[#7C8DB0] text-sm font-normal">
      ...
      <div className="w-full h-[330px] flex flex-col items-start rounded-b-xl bg-white dealsShadow">
          ...
          <div className="w-full h-full flex flex-col justify-center items-start gap-1 px-4">
            <div className="flex flex-row items-center justify-between w-full">
              ...
              <p className="text-[#6E7491] text-base font-medium">SAR 39</p>
            </div>
            <p className="text-[#7C8DB0] text-sm font-normal">
